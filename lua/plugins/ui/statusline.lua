...
-- highlight("StatusLineMode", "red", theme.red)
...
M.modes = setmetatable({
  ...
  ["v"]  = "visual",
  ["V"]  = "l-visual",
  [""] = "b-visual", -- this is not ^V, but it's , they're different
  ["s"]  = "S",
  ["S"]  = "S·L",
...
M.get_filepath = function(self)
  ...
  -- local filepath = fn.fnamemodify(fn.expand "%", ":.:r")
  if
    filepath == ""
    or filepath == "."
...
-- https://elianiva.my.id/post/neovim-lua-statusline#creating-the-statusline
